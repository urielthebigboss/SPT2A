      ...
      <div className="nutri-start-inner">
        ...
        >
          <motion.h1 variants={fadeUp}>
            Bien manger, <span className="nutri-start-grad">mieux vivre</span>
            <br />
            avec SPT2A
          </motion.h1>
          ...
          <motion.p className="nutri-start-desc" variants={fadeUp}>
            ...
            sélectionne des aliments sains, locaux et riches en nutriments parce
            que bien manger est le premier geste pour bien vivre.
          </motion.p>
